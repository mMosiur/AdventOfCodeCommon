...
public static class EnumeratorExtensions
{
	...
	/// <summary>
	/// Extensions for generic enumerators (<see cref="IEnumerator{T}"/>).
	/// </summary>
	...
	extension<T>(IEnumerator<T> enumerator)
	{
		...
		public void EnsureMoveNext(string? message = null)
		{
	...
	/// <summary>
	/// Extensions for <see cref="string"/> enumerators (<see cref="string"/>-specialized <see cref="IEnumerator{T}"/>).
	/// </summary>
	/// <param name="enumerator">The enumerator to be advanced.</param>
	extension(IEnumerator<string> enumerator)
	{
		...
		/// <exception cref="ArgumentNullException">Thrown when the <paramref name="enumerator"/> is <see langword="null"/>.</exception>
		/// <exception cref="InvalidOperationException">Throws when the end of the collection has been reached.</exception>
		public void EnsureMoveToNextNonEmptyLine(string? message = null, bool skipCurrent = true)
		{
			ArgumentNullException.ThrowIfNull(enumerator);
			if (skipCurrent)
			{
